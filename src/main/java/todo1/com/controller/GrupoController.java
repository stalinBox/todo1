...
@RestController
@Api(value = "Rest Api example", tags = "GRUPO")
...
public class GrupoController implements ErrorController {
	private static final String PATH = "/error";
	public static final Logger LOGGER = LoggerFactory.getLogger(GrupoController.class);
	 ...
	 */
	@GetMapping(value = "/{id}")
	@ApiOperation(value = "Obtiene el registro por id", response = Grupo.class)
	@ResponseStatus(HttpStatus.OK)
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ResponseController> update(@RequestBody Grupo update) {
		Grupo grupoUpdated = grupoService.update(update);
		return ResponseEntity.ok(new ResponseController(grupoUpdated.getGrup_id(), "Actualizado"));
	}
