...
@RestController
@Api(value = "Rest Api example", tags = "PRODUCTO")
...
public class ProductoController implements ErrorController {
	 ...
	 */
	@GetMapping(value = "/")
	@ApiOperation(value = "Obtiene todos los registros de la entidad detalle ventas", response = Producto.class)
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<?> findAll() {
		List<Producto> grupo = productoService.findAll();
	 ...
	 */
	@GetMapping(value = "/{id}")
	@ApiOperation(value = "Obtiene el registro por id", response = Producto.class)
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<Optional<?>> findById(@PathVariable Long id) {
		Optional<Producto> grupo = productoService.findById(id);
		return ResponseEntity.ok(grupo);
	}
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ResponseController> update(@RequestBody Producto update) {
		Producto productoUpdated = productoService.update(update);
		return ResponseEntity.ok(new ResponseController(productoUpdated.getProd_id(), "Actualizado"));
	}
