...
@RestController
@Api(value = "Rest Api example", tags = "SUBGRUPO")
...
public class SubGrupoController implements ErrorController {
	private static final String PATH = "/error";
	public static final Logger LOGGER = LoggerFactory.getLogger(SubGrupoController.class);
	 ...
	 */
	@GetMapping(value = "/")
	@ApiOperation(value = "Obtiene todos los registros de la entidad detalle ventas", response = SubGrupo.class)
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<?> findAll() {
		List<SubGrupo> grupo = subGrupoService.findAll();
	 ...
	 */
	@GetMapping(value = "/{id}")
	@ApiOperation(value = "Obtiene el registro por id", response = SubGrupo.class)
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<Optional<?>> findById(@PathVariable Long id) {
		Optional<SubGrupo> grupo = subGrupoService.findById(id);
		return ResponseEntity.ok(grupo);
	}
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ResponseController> update(@RequestBody SubGrupo update) {
		SubGrupo subGrupoUpdated = subGrupoService.update(update);
		return ResponseEntity.ok(new ResponseController(subGrupoUpdated.getSgrup_id(), "Actualizado"));
	}
